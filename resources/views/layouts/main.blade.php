...
<head>
    ...
    <link rel="icon" href="{{asset("image/TOPC_logo.png")}}" sizes="any">
    <link rel="icon" href="{{asset("image/TOPC_logo.png")}}" type="image/svg+xml">
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li style="font-weight: bold" @if(Request::decodedPath()=="time/enter" ) class="active" @endif><a onclick="return movePageControl();" href="{{asset("time/enter")}}" @if(isset($navigation_status[0]["intro"]) && $navigation_status[0]["intro"]) style="font-weight: bold;color:#292939" @endif>&nbsp;Time Entry</a></li>
                    <!--予算照会-->
                    ...
                    <!--Synk Tools-->
                    <li style="font-weight: bold" @if(Request::decodedPath()=="sync_tools" ) class="active" @endif><a onclick="return movePageControl();" href="{{asset("sync_tools")}}" @if(isset($navigation_status[0]["personal_info"]) && $navigation_status[0]["personal_info"]) style="font-weight: bold;color:#292939" @endif>&nbsp;Sync Tools</a></li>
